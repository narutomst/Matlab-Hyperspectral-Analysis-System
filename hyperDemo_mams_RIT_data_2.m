...
%--------------------------------------------------------------------------
% Parameters
inputFilename = 'D:\MA毕业论文\ATrain_Record\20191002\data\self_test\HyMap\self_test_rad.img';
...
for q = 1:p
    ...
    timeElapse_1 = toc(timerVal_1);
    if timeElapse_1 > 10*60
        return;
    end
end
